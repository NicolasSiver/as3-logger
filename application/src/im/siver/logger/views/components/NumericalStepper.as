 ...
 * 
 *  @default mx.im.siver.logger.views.skins.halo.NumericStepperDownSkin
 *  
 *  @langversion 3.0
 *  @playerversion Flash 9
 *  @playerversion AIR 1.1
 ...
 *  
 *  @default mx.im.siver.logger.views.skins.halo.NumericStepperUpSkin
 *  
 *  @langversion 3.0
 *  @playerversion Flash 9
 *  @playerversion AIR 1.1
...
[Alternative(replacement="spark.im.siver.logger.views.components.NumericStepper", since="4.0")]
