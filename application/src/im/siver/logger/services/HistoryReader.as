package im.siver.logger.services {
    ...
    public class HistoryReader {
        ...
        // Recents
        public static var items:Vector.<HistoryItem> = new Vector.<HistoryItem>();
         ...
         * Add an item
         */
        public static function add(client:LoggerClient):void {
            ...
            if (client.fileLocation.indexOf("http://") == 0 || client.fileLocation.indexOf("https://") == 0) {
                ...
                // Add
                var itemWeb:HistoryItem = new HistoryItem();
            ...
            if (file.exists) {
                ...
                // Add
                var itemFile:HistoryItem = new HistoryItem();
